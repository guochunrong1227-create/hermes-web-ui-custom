...
<template>
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed }">
    <RouteLinkItem class="sidebar-logo" :to="{ name: 'hermes.chat' }">
      <img :src="logoPath" alt="长松咨询" class="logo-img" />
      <span class="logo-text">长松咨询</span>
    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <a class="website-link" href="https://nx.cs360.cn/" target="_blank" rel="noopener noreferrer" title="经营突破">
